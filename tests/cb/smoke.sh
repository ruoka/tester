...
test_spliced_string_import() {
  ...
  run_cb_list "${work_dir}"
  assert_jsonl_contains '"module":"cycle_a","kind":"interface","imports":[]' "spliced_string_no_phantom_edge"
  assert_jsonl_not_contains '"module":"cycle_a","kind":"interface","imports":["cycle_b"]' "spliced_string_no_cycle_a_imports_b"
