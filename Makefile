...
SUBMODULE_PREFIX = ..
# If PREFIX was passed from parent, it's already relative to deps/tester (e.g., ../../build)
# If not, use default ../build
ifdef PREFIX
# PREFIX was explicitly set (likely by parent), use it directly
SUBMODULE_PREFIX_ARG = $(PREFIX)
else
# Use default relative to deps/tester
