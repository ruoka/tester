...
**Current release: [`v2.1.1`](https://github.com/ruoka/tester/releases/tag/v2.1.1)** — Clang 21 + libc++ modules, JSONL, CB (`--modules=`, `posix_spawn`, modular `object_stale` fix), CMake + Ninja, distinct Make/CMake build trees. Prior supported tags: [`v2.1.0`](https://github.com/ruoka/tester/releases/tag/v2.1.0), [`v2.0.0`](https://github.com/ruoka/tester/releases/tag/v2.0.0). The November 2025 `v1.0.0` GitHub pre-release is historical and unsupported.
